...
params:
  ...
  LUGAR_3: "Lima"
  DESTINATARIO_4: "Sr/a"
  EFA_5: "Oficina Desconcentrada XXXXX"
  DPTO_EFA_6: "LIMA"
  PROV_EFA_7: "LIMA"
...
|                |     | Jefe/a de la `r EFA[[1]]`                                      |
| **CC**         |  :  | **ALICIA PERALTA RODRÍGUEZ**                                   |
|                |     | Coordinador/a de Oficina Desconcentradas                       |
| **ASUNTO**     |  :  | Reitero solicitud de información                               |
| **REFERENCIA** |  :  | `r AUX_2[[1]]`                                                 |
|                |     | (Código de problema: [**`r AUX_1[[1]]`**]{.ul})                |
| **FECHA**      |  :  | Lima, `r day(now())` de `r Mes_actual[[1]]` de `r year(now())` |
